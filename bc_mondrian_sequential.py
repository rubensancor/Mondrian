...
parser.add_argument('--full_train', action='store_true', help='Enables the full train mode training the model with all the dataset to calculate the embeddings in the final interaction.')
...
wandb.init(project="mondrian", config=args, tags='JODIE_seq')
